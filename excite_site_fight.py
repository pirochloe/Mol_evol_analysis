...
with open("conservative_site_analysis.txt","w") as g:
...
for focus_group in s:
    ...
    plt.grid()
    fig.savefig("histogram_"+str(focus_group)+".png")
    
    with open("group_analysis_"+str(focus_group)+".txt","w") as I:
    ...
    H.to_csv("conservation_site_analysis_"+str(focus_group)+".csv")
